...
| Native Interception inference client | Implemented and tested against the PR #4 bridge; no scheduler caller wired yet |
...
Use the local `.inference_bridge/connection.json` generated by Interception. See [the inference contract](docs/INFERENCE.md) for a small caller example and the current scheduler boundary.
